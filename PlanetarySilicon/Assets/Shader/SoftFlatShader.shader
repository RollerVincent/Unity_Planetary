  ...
  SubShader {
   Pass {   
     ...
     float4 frag(vertexOutput input) : COLOR
     {
      ...
      //return float4(input.vertexLighting + ambientLighting + (diffuseReflection + specularReflection)*shadow, 1.0);
      return float4((diffuseReflection + specularReflection)*shadow, 1.0);
     }
     ENDCG
   }
